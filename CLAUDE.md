...
- **PWA:** sw.js (network-first สำหรับ navigation, SWR สำหรับ asset, ไม่แตะ docs.google.com) — แก้โค้ดแอปแล้วต้องเพิ่ม `CACHE_VERSION` ใน sw.js · ปัจจุบัน `cpf-v14`
...
- แก้โค้ดแล้วต้องเพิ่ม `CACHE_VERSION` ใน sw.js ทุกครั้ง (ปัจจุบัน `cpf-v14`)
...
- **ที่ผู้ใช้เคยถามแล้วปฏิเสธ (อย่าเสนอซ้ำเว้นแต่ผู้ใช้ขอ):** ฟีเจอร์คืนเงินยืม/ยอดสุทธิ · บอทถ่ายรูป→ลงชีตอัตโนมัติ (Apps Script OCR / Discord / LINE) · เปลี่ยน emoji เป็น SVG icon
