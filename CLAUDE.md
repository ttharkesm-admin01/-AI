...
- **PR #48:** redesign export infographic เป็น **PNG ธีมเขียวโมโนโทน** ตามรูปดีไซน์อ้างอิงที่ผู้ใช้ส่งมา (เอาเฉพาะสไตล์ — เนื้อหา/ชื่อโรงงานยังของเรา) —
  ...
  - bump SW `cpf-v19`
- **PR #49:** แก้ตัวเลขกราฟใน export PNG เล็กอ่านยาก — ต้นเหตุ: canvas 760px โดนย่อลงช่อง ~265px (เกือบ 3 เท่า) · กราฟแท่ง export เปลี่ยนเป็น 530×420 (สัดส่วนตรงช่อง เต็มช่องพอดี) + ฟอนต์ตัวเลขบนแท่ง 17px/แกน 14-13px เฉพาะตอน export (`barValueLabel` plugin อ่าน font จาก `options.plugins.barValueLabel.font`) · โดนัท 460px legend 16px · OT ใช้ 1420×360 ตามช่องกว้างของตัวเอง · bump SW `cpf-v20`
