...
- **PWA:** sw.js (network-first สำหรับ navigation, SWR สำหรับ asset, ไม่แตะ docs.google.com) — แก้โค้ดแอปแล้วต้องเพิ่ม `CACHE_VERSION` ใน sw.js · ปัจจุบัน `cpf-v9`
...
- แก้โค้ดแล้วต้องเพิ่ม `CACHE_VERSION` ใน sw.js ทุกครั้ง (ปัจจุบัน `cpf-v9`)
...
- **PR #38:** แก้กราฟ infographic ให้สมมาตร/อ่านออก — `object-fit:fill`→`contain` (เลิกยืดภาพ), กริดกราฟ `1fr 1.6fr`→`1fr 1fr`, สูง 185→210px + พื้นการ์ดขาว · bump SW `cpf-v9`
